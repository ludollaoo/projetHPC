...
#define vec_left1(v1, v2) (vuint8)_mm_shuffle_pd(_mm_srli_si128((vuint8)_mm_shuffle_pd(v1, v2, 0b01),7),_mm_slli_si128(v2, 1), 0b10)

#define vec_left2(v1, v2) (vuint8)_mm_shuffle_pd(_mm_srli_si128((vuint8)_mm_shuffle_pd(v1, v2, 0b01),6),_mm_slli_si128(v2, 2), 0b10)

#define vec_right1(v1, v2) (vuint8)_mm_shuffle_pd(_mm_srli_si128(v1, 1), _mm_slli_si128((vuint8)_mm_shuffle_pd(v1, v2, 0b01),7), 0b10)

#define vec_right2(v1, v2) (vuint8)_mm_shuffle_pd(_mm_srli_si128(v1, 2), _mm_slli_si128((vuint8)_mm_shuffle_pd(v1, v2, 0b01),6), 0b10)
