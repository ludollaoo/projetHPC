...
void erosion5_rot_simd_openMP(vuint8** X, int nrl, int nrh, int ncl, int nch, vuint8** Y);
...
void dilatation5_rot_simd_openMP(vuint8** X, int nrl, int nrh, int ncl, int nch, vuint8** Y);
