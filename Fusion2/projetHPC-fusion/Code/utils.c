...
void resize(int nrl, int nrh, int ncl, int nch){
	...
	for(int n_img = 0; n_img < 200; n_img++){
		...
		get_path(n_img, nom, "/home/ludovic/HPC/Projet/Fusion2/projetHPC-fusion/car3/car_3", NULL);
		...
		sprintf(nom, "/home/ludovic/HPC/Projet/Fusion2/projetHPC-fusion/car3/resized_car_3%03d.pgm", n_img);
